document.addEventListener('DOMContentLoaded', function() {
  ...
  contactForm.addEventListener('submit', function(e) {
    ...
    alert('✨Due to high activity, our contact service is currently unavailable. Please feel free to reach out to us directly using the email address provided in the portfolio. We apologize for the inconvenience and appreciate your understanding.');
    contactForm.reset();
  });
